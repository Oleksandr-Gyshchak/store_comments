              ...
              <div class="rw">
                ...
                <p>
                    ...
                    <a href="#postModalEdit" class="boa" data-toggle="modal" for="edit" data-id="${post._id}">
                        <button class="cg nz ok" data-id="${post._id}" for="edit" title="Редактировать магазин">
                            <span class="h bit"></span> Редактировать магазин
                        </button>
                    </a>
        ...
        e.target.innerHTML = `
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="d">
                        <h4 class="modal-title" id="postTitleCreate">Добавить магазин</h4>
